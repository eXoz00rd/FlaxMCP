...
Mirrored from `eXoz00rd/HEngine`'s `.claude/skills/backlog-task/SKILL.md` and adapted to this
...
- **Never add AI self-attribution** (no `Co-Authored-By: Claude` trailers, no "Generated with
  Claude Code" lines) — repo and user convention both forbid it.
